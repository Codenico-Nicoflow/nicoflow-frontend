              ...
              <div className="relative flex-1">
                <FormControl>
                  <Input
                    ...
                    value={field.value ?? ''}
                    className="h-10 sm:h-12 pe-16 text-sm sm:text-base"
                    onBlur={field.onBlur}
                    name={field.name}
                    ref={field.ref}
                  />
                </FormControl>
                <div className="absolute end-3 top-1/2 -translate-y-1/2 text-xs sm:text-sm text-muted-foreground pointer-events-none">
                  {t('fields.minutes')}
                </div>
              </div>
              {field.value && (
