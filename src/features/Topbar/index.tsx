  ...
  return (
    <header className="flex h-14 shrink-0 items-center gap-3 border-b border-border/60 bg-background px-3 sm:px-4">
      ...
      >
        ...
        <span className="hidden sm:inline">Nicoflow</span>
      </button>
      ...
      <button
        type="button"
        aria-label="Search"
        className="ml-2 flex h-9 max-w-md flex-1 items-center gap-2 rounded-md border border-input bg-muted/40 px-3 text-sm text-muted-foreground hover:bg-muted/60 transition-colors"
      >
