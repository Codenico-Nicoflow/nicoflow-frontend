  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-3xl mx-auto px-6 py-12">
        ...
        <h1 className="text-3xl font-bold tracking-tight mb-2">{t('pages.termsOfService.title')}</h1>
        <p className="text-sm text-muted-foreground mb-10">{t('pages.termsOfService.lastUpdated')}</p>

        <div className="prose prose-sm max-w-none space-y-8 text-foreground">
          <section>
            <h2 className="text-lg font-semibold mb-3">{t('pages.termsOfService.s1Title')}</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3">{t('pages.termsOfService.s2Title')}</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3">{t('pages.termsOfService.s3Title')}</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3">{t('pages.termsOfService.s4Title')}</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3">{t('pages.termsOfService.s5Title')}</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3">{t('pages.termsOfService.s6Title')}</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3">{t('pages.termsOfService.s7Title')}</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold mb-3">{t('pages.termsOfService.s8Title')}</h2>
            <p className="text-muted-foreground leading-relaxed">
